...
export default function Component() {
  const [chatDataGroupState, setChatDataGroup] = useState<ChatData[]>(chatDataGroup);
  ...
  const handleDeleteClick = (index: number, event: React.MouseEvent<HTMLParagraphElement>) => {
  ...
  const handleSendReply = () => {
    ...
    localStorage.setItem("chatDataGroupState", JSON.stringify([...chatDataGroupState, newReply]));
  ...
  const sendMessage = () => {
    ...
    localStorage.setItem("chatDataGroupState", JSON.stringify([...chatDataGroupState, newChat]));
    ...
    <main className='h-[80vh] w-[734px] bg-white fixed bottom-24 right-4 shadow-md tracking-wide rounded-md z-40'>
      ...
      {showInboxDetail ? (
        ...
        <div className='flex items-center justify-between p-4 bg-white border-b'>
          <div className='flex gap-3 items-center' onClick={() => setShowInboxDetail(true)}>
                ...
                <div
                  className={
                    chat.sender === "You"
                      ...
                      : chat.sender ===
                        "Mary Hilda"
                      ? "bg-[#FCEED3] p-4 rounded-lg"
                      : "bg-[#D2F2EA] p-4 rounded-lg"
                  }
                >
                  <p>{chat.message}</p>
